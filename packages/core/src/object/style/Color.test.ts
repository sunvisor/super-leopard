...
describe('Tests for Color', () => {
  ...
  describe('Tests for Invalid Color', () => {
    ...
    it('should throw an error when invalid color type red', () => {
      expect(() => new Color({ r: 256, g: 0, b: 0 })).toThrow('Invalid RGB color');
    });

    it('should throw an error when invalid color type green', () => {
      expect(() => new Color({ r: 0, g: -1, b: 0 })).toThrow('Invalid RGB color');
    });

    it('should throw an error when invalid color type blue', () => {
      expect(() => new Color({ r: 0, g: 0, b: 256 })).toThrow('Invalid RGB color');
    });

    it('should throw an error when hex string does not start with #', () => {
    ...
    it('should throw an error when invalid hex length', () => {
