...
import { Scale, UnitType } from "./Scale";


describe('Tests for serializeScale', () => {

  it('should return serialized ScaleData', () => {
    // Arrange
  ...
  it('should return an empty object when serializing a Scale with all properties omitted', () => {
    // Arrange
    const scale = new Scale({});
    // Act
    const scaleData = serializeScale(scale);
